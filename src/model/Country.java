...
public class Country {
	...
	//a country through the country builder, this constructor receives the countrybuilder from the build() method.
	//It use the values defined on the inner class (builder) to create a new Country
	...
	//This method will generate a well formatted print statement with information regarding the country
	@Override
	...
	public static class CountryBuilder {
		...
		/**
		 * @param code this is the most important attribute, it's a primary key, therefore it's mandatory
		 * @param name according to the database, it can't be null and there is no default value, therefore it's also mandatory
		 * @param continent it also can't be null, but it has a default value of 'Asia' on the database
		 */
		...
		//Surface Area was not considered essential because it has a default value of 0.00 on the database
		//So if a user does not know the surface area, they can leave it as null (will be create with 0.00)
		public CountryBuilder setSurfaceArea(float surfaceArea) {
			this.surfaceArea = surfaceArea;
			return this;
		}
		
		//The Head of State is the only attribute than can be null according to the database
		...
		/**
		 * the build method is the most important method on the builder pattern
		 * it is responsible for.... build a new instance of the country object 
